...
const cases: CasePanel[] = [
  ...
  },
  {
    ...
    bullets: [
      ...
      "Works on iMessage, WhatsApp, or SMS",
    ],
  ...
  },
  {
    ...
    body: "You're an NIAS paramedic on the A1. Patient is unconscious. SMS is all you have.",
    bullets: [
      "Break-glass releases only critical fields",
      "Works over plain SMS when iMessage and data aren't available",
